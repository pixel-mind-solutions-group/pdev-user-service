...
import com.pdev.user_service.constant.AuthErrorMessages;
            ...
            if (Boolean.TRUE.equals(valid)) {
                ...
                if (jwtUtil.hasRecruitmentPermission(azpWithRoles)) {
                    ...
                    for (Map.Entry<String, String> roleWithScope : userRolesWithScope.entrySet()) {
                        if (roleWithScope.getKey().equals(RolePermissionsConstants.APP_SCOPE_USER_AUTH_SERVICE)) {
                    ...
                    for (Map.Entry<String, List<String>> azpWithRole : azpWithRoles.entrySet()) {
                        if (azpWithRole.getKey().equals(RolePermissionsConstants.CLIENT_ID_USER_AUTH) &&
                                azpWithRole.getValue().contains(RolePermissionsConstants.PERMISSION_USER_AUTH_SERVICE)) {

                            grantedAuthorities.add(new SimpleGrantedAuthority(RolePermissionsConstants.PERMISSION_USER_AUTH_SERVICE));
                        }
                    }
