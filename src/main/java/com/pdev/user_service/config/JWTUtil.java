...
public class JWTUtil {
    ...
    public boolean hasRecruitmentPermission(Map<String, List<String>> azpWithRoles) {
        ...
        if (azpWithRoles != null && !azpWithRoles.isEmpty()) {
            ...
            List<String> permissions = azpWithRoles.get(RolePermissionsConstants.CLIENT_ID_USER_AUTH);
            return !permissions.isEmpty() && permissions.contains(RolePermissionsConstants.PERMISSION_USER_AUTH_SERVICE);
        }
